...
- **Google Workspace** (pre-§15): resources are on Shared Drives only; all SDK access goes through the dedicated services listed in §13. `ITeamResourceGoogleClient` (PR #274) is the extracted connector for the Teams→Drive bridge specifically.
