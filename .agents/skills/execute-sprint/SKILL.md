...
Follow the batch worker process documented in `.Codex/agents/batch-worker.md`.

## Project context

Read these files before starting:
- `AGENTS.md` — project orientation and architecture overview
...
1. **After implementing each issue:** Run spec compliance review per `.Codex/agents/spec-compliance-reviewer.md`. Compare your code against EVERY acceptance criterion. Max 3 fix iterations.
